@extends('layouts.superadmin') {{-- INI YANG DIPERBAIKI (huruf s kecil) --}}
...
<div class="page-container">
  ...
  <div class="header-merah">
    ...
    <div class="header-actions">
      ...
      <button type="submit" form="formTambahEvent" class="btn-action btn-simpan-head">
        &#128190; Simpan
      </button>
    </div>
  </div>
  ...
  <!-- ══ FORM BODY ══ -->
  <div class="form-body">
    <form id="formTambahEvent" action="javascript:void(0)" onsubmit="simulasiSimpan()" method="POST" enctype="multipart/form-data">
      @csrf
      ...
      <div class="form-group">
        ...
        <textarea id="deskripsi" name="deskripsi" placeholder="Masukkan deskripsi event.." required></textarea>
      </div>
      ...
      <div class="form-group">
        ...
        <select id="kategori" name="kategori" required>
          ...
          <option value="eksternal">Pementasan Eksternal</option>
      ...
      <div class="form-group">
        ...
        <input type="text" id="lokasi" name="lokasi" placeholder="Masukkan lokasi Event.." required>
      </div>
...
<script>
  ...
  function simulasiSimpan() {
    alert('Simulasi Frontend: Data Event berhasil disimpan!');
