...
<div class="page-container">
  ...
  <div class="header-merah">
    ...
    <div class="header-actions">
      ...
      <button type="submit" form="formTambahPengurus" class="btn-action btn-simpan">💾 Simpan</button>
    </div>
  </div>
    ...
    <form id="formTambahPelatih" action="javascript:void(0)" onsubmit="alert('Data Pelatih berhasil ditambahkan!')">
      ...
      <div class="form-group">
        ...
        <div class="custom-file-wrapper">
          <label for="foto_pengurus" class="btn-pilih-file">Pilih File</label>
          <span class="file-name-display" id="nameLabel">Masukkan foto pengurus...</span>
      ...
      <div class="form-group">
        ...
        <input type="text" id="nama" name="nama" placeholder="Masukkan nama lengkap pengurus..." required>
      </div>
      ...
      <div class="form-group">
        ...
        <select id="jabatan" name="jabatan" required>
          <option value="" disabled selected hidden>Pilih jabatan pengurus...</option>
      ...
      <div class="form-group">
        ...
        <input type="text" id="instagram" name="instagram" placeholder="Masukkan link instagram pengurus...">
      </div>

      <!-- NO HANDPHONE -->
      <div class="form-group">
        <label for="hp">No Handphone</label>
        <input type="text" id="hp" name="no_hp" placeholder="Masukkan no handphone pengurus..." required>
      </div>
