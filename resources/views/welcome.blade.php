...
<nav>
  <div class="nav-logo">
    <img src="{{ asset('img/logo-jeb.png') }}" alt="Logo JEB" class="logo-img-nav" />
    <span>JEB</span>
  </div>
  <div class="nav-links">
...
<section id="beranda">
  <div class="hero-grid">
    ...
    <div class="hero-logo-wrap">
      <img src="{{ asset('img/logo-jeb.png') }}" alt="Logo Sanggar Jiwa Etnik Blambangan" class="logo-img-hero" />
    </div>
  </div>
</section>
